...
type TestingState = {
        ...
        data      : Map<string, metavcoin.Types.Data.data>
...
let mutable testingState = {
        ...
        module MessageBody =
            ...
            let getData dataType (value : string) =
                ...
                | "string" ->
                    value.Trim('"')
                    |> fsToFstString
                    |> metavcoin.Types.Data.String
                | "i64" ->
                    Int64.Parse value
                    |> metavcoin.Types.Data.I64
                | "u32" ->
                    UInt32.Parse value
                    |> metavcoin.Types.Data.U32
                | "u64" ->
                    UInt64.Parse value
                    |> metavcoin.Types.Data.U64
                | _ ->
            ...
            let getDataCollection collectionType dataType =
                ...
                >> match collectionType with
                    | "list" -> fsToFstList >> metavcoin.Types.Data.List
                    | "array" -> Array.ofList >> metavcoin.Types.Data.Array
                    | _ -> failwithf "Unrecognized data collection type: %A" dataType
                >> metavcoin.Types.Data.Collection
    ...
    module Transaction =
        ...
        let extendContract contractLabel txLabel blocks =
            ...
            let outputs =
                [ { spend = { amount = extensionSacrifice; asset = Asset.metavcoin }; lock = ExtensionSacrifice contractId } ]
    ...
    module Asset =
        ...
        let mockAsset label =
            if label = "metavcoin" || label = "metavcoin" || label = "metavcoin"
                then Asset.metavcoin
                else
        ...
        let getAsset value =
            if value = "metavcoin" then Asset.metavcoin
            else
