...
let Anonymous = metavcoin.Types.Main.Anonymous
let ContractSender (ContractId (version, Hash.Hash cHash)) = metavcoin.Types.Main.Contract (version,cHash)
let PKSender (Crypto.PublicKey publicKey) = metavcoin.Types.Main.PK publicKey
