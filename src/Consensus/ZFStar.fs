...
let unCost (Cost.C inj:metavcoin.Cost.Realized.cost<'Aa, 'An>) : 'Aa = inj.Force()

let pickler = Pickler.auto<metavcoin.Types.Data.data>
...
let fstTofsMessage (msg: metavcoin.Types.Main.message) : Consensus.Types.Message =
