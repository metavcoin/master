...
module RT     = metavcoin.ResultT
module Dict   = metavcoin.Dictionary
module TX     = metavcoin.TxSkeleton
module CR     = metavcoin.ContractResult
module Asset  = metavcoin.Asset
module OptT   = metavcoin.OptionT
module Wallet = metavcoin.Wallet
